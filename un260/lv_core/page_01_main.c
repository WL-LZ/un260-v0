...
//////////////////////////////////////////////////////
    ...
    { "esc_img", LV_OBJ_TYPE_IMAGE, &page_01_esc_icon,
        { 1167, 254, 38, 38, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "list_img", LV_OBJ_TYPE_IMAGE, &page_01_list_icon,
        { 31, 184, 39, 24, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "menu_img", LV_OBJ_TYPE_IMAGE, &page_01_menu_icon,
        { 1167, 31, 35, 35, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "mode_img", LV_OBJ_TYPE_IMAGE, &page_01_mode_icon,
        { 30, 43, 42, 34, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "print_img", LV_OBJ_TYPE_IMAGE, &page_01_print_icon,
        { 32, 249, 38, 35, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "set_img", LV_OBJ_TYPE_IMAGE, &page_01_set_icon,
        { 33, 113, 35, 35, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "start_img", LV_OBJ_TYPE_IMAGE, &page_01_start_icon,
        { 1167, 142, 41, 35, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },

    { "usb_img", LV_OBJ_TYPE_IMAGE, &page_01_usb_icon,
        { 985, 353, 22, 30, 0, 0, 0 },
        { NULL, 0, 0, 0, NULL },
        { 255, 0, 0, false },
        NULL, 0, NULL, NULL },
